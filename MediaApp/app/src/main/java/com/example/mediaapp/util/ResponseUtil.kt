...
object ResponseUtil {
    fun handlingResponseReturnWithValue(
        response: Response<ResponseBody>,
        successToast: String,
        toast: MutableLiveData<String>,
        nameValue: String,
        isHaveNoMessageError: Boolean = false,
        messageError: String = ""
    ): String {
    ...
    fun handlingResponseListDirectory(
        response: Response<List<Directory>>,
        toast: MutableLiveData<String>
    ): List<Directory> {
        return if (response.isSuccessful) {
            toast.postValue("")
    ...
    fun handlingResponseListFile(
        response: Response<List<File>>,
        toast: MutableLiveData<String>
    ): List<File> {
        return if (response.isSuccessful) {
            toast.postValue("")
